...
private[binary] final case class ArrayBinary private[binary] (private[binary] var array: Array[Byte], private[binary] var offset: Int, private var _length: Int) extends Binary with Serializable {
